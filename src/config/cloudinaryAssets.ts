...
export const cloudinaryAssets: CloudinaryAssets = {
  ...
  uiux: {
    ferryeasy: {
      thumbnail: 'https://res.cloudinary.com/du4nug3uk/image/upload/v1770567653/FerryEasy_UI_UX_Portfolio_2.0_page-0001_lcrj4x.jpg',
      images: [
    ...
    covaccine: {
      thumbnail: 'https://res.cloudinary.com/du4nug3uk/image/upload/v1770569996/1-co-vaccine-uiux-1920_v4doyx.png',
      images: [
